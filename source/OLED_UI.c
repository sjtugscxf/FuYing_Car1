...
void displayParameters()//menu==1
{
  ...
  Putboth outpair[Pages][Rows]={
    ...
    {
      {"curvL[0]", curvatureL[0]},
      {"curvL[1]", curvatureL[1]},
      {"curvL[2]", curvatureL[2]},
      {"curvL[3]", curvatureL[3]},
      {"curvL[4]", curvatureL[4]},
      {"curvL[5]", curvatureL[5]},
      {"curvL[6]", curvatureL[6]},
      {"curvL[7]", curvatureL[7]},
      {"curvL[8]", curvatureL[8]},
      {"curvL[9]", curvatureL[9]},
      {"curvL[10]", curvatureL[10]},
      {"curvL[11]", curvatureL[11]},
      {"curvL[12]", curvatureL[12]},
      {"curvL[13]", curvatureL[13]},
      {"curvL[14]", curvatureL[14]},
      {"curvL[15]", curvatureL[15]},
      {"curvL[16]", curvatureL[16]},
      {"curvL[17]", curvatureL[17]},
      {"curvL[18]", curvatureL[18]},
      {"curvL[19]", curvatureL[19]},
      {"curvL[20]", curvatureL[20]},
      {"curvL[21]", curvatureL[21]},
      {"curvL[22]", curvatureL[22]}
    },
    {
      {"slope[0]", slope[0]},
      {"slope[1]", slope[1]},
